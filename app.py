...
if selection == "Estadísticas Generales":
    ...
    # Añadir selección de países en la barra lateral
    selected_countries = st.sidebar.multiselect(
        "Selecciona países", df_countries['country'].tolist(), default=df_countries['country'].tolist()
    )

    # Filtrar los datos según la selección de países
    df_stats = df_stats[df_stats['country'].isin(selected_countries)]
